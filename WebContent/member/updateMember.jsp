	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="id" type="text" class="form-control" placeholder="id" readonly="readonly"
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="password_confirm" type="text" class="form-control" required="required"
			...
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					...
					<a href="deleteMember.jsp" class="btn btn-primary" onclick="getOut()">회원탈퇴</a>
				</div>
			</div>
		</form>	
	</div>
